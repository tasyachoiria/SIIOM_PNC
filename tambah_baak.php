...
<div class="main">
    <div class="jumbotron p-5">
        <div class="container text-center p-5">
            <h1 class="text-center">TAMBAH BAAK</h1>
            <form action="c_tambahbaak.php" method="post">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <input type="number" class="form-control" placeholder="id data pembayaran iom" name="id_data_pembayaran_iom" Required="">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col">
